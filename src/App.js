        ...
        <div className="topic">
            ...
            <div className="topic-content">
                <div className="topic-text" style={{ width: '97.5%' }}>Sound is associated with vibrational or
                    ...
                    various forms of energy-one of them being sound. Various objects vibrate in to produce sound. You
                    know that there are a variety of musical instruments producing different type of sounds Musical
                    ...
                    by a organ called larynx (commonly called voice box). When we speak, air rushes out of our lungs to
                    larynx via windpipe. Larynx is located at top end of the windpipe.
                    On the top of the larynx there are two membranes called vocal folds (ommonly called vocal chords),
                    which begain to vibrate because of air rushing in from below.
                </div>
            </div>
        </div>
    </div>
